...
class home(BoxLayout ):
    ...
    device_name = ListProperty(['oic.d.airconditioner' , 'oic.d.airpurifier','oic.d.dishwasher','oic.d.dryer','oic.d.light','oic.d.oven','oic.d.refrigerator','oic.d.robotcleaner','oic.d.sensor','oic.d.smartlock'])
    device = [ObjectProperty(True),ObjectProperty(False),ObjectProperty(False),ObjectProperty(False),ObjectProperty(False),ObjectProperty(False),ObjectProperty(False),ObjectProperty(False),ObjectProperty(False),ObjectProperty(False)]
